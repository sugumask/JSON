...
class FormCreation extends Component {
    ...
    render() {
        ...
        return (
            <div>
                {/* <h2 onClick={()=>this.props.history.push('/edit/3')}>Create Form</h2> */}
                {/* <form>
                ...
                <>{ 
                    !this.state.biodata.length ? <div className='load'>Loading...</div> :
                        this.state.biodata.map(item => <ComponentData item={item} click={this.componentClicked}/>)
                }
